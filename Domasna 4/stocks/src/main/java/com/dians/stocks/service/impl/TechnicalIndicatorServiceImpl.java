...
import com.dians.stocks.factory.MomentumIndicatorFactory;
import com.dians.stocks.factory.TrendIndicatorFactory;
...
public class TechnicalIndicatorServiceImpl implements TechnicalIndicatorService {
    ...
    public List<TechnicalIndicator> getTrendIndicators(Long companyId) {
    ...
    public List<TechnicalIndicator> getMomentumIndicators(Long companyId) {
        this.stocks = this.stockDetailsService.findLast30ByCompanyId(companyId).reversed();
    ...
    public List<String> getFinalSignalsList(Long companyId) {
        ...
        finalSignals.add(getFinalSignalByTimeframe(7, IndicatorHelper.getLastNStocks(this.stocks, 7).size(), getTrendIndicators(companyId), getMomentumIndicators(companyId)));
        finalSignals.add(getFinalSignalByTimeframe(30, IndicatorHelper.getLastNStocks(this.stocks, 30).size(), getTrendIndicators(companyId), getMomentumIndicators(companyId)));
        return finalSignals;
    }
